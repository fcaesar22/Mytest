...
<div class="row">
    ...
    <div class="col-md-12" align="center">
    		<h4 class="card-title">Edit Article <?php if ($kpi == 246) { echo "DensLife"; } if ($kpi == 247) { echo "densplay"; } if ($kpi == 325) { echo "DensKnowledge"; } ?></h4>
    </div>
</div>
<hr>
<br>
    ...
    <div id="content-wrapper">
      	<div class="container-fluid">
            <div class="well" style="margin-top:50px;">
                ...
                <fieldset>
                    <legend></legend>
                    <form role="form" action="<?php echo site_url('denslife/denslife/update_product');?>" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <input class="form-control" type="hidden" name="contype" id="contype" value="<?php echo $kpi?>" required="">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        function get_data_edit(){
            ...
            $.ajax({
                url : "<?php echo site_url('denslife/denslife/get_data_edit');?>",
                method : "POST",
    ...
    $(document).ready(function (){
        $("body").on('click', '.btn-add-more', function (e) {
            ...
            var $html = '<tr class="jdr1" id="' + rowid + '">' +
                ...
                '<td><input type="text" name="jtag[]" placeholder="tag" class="form-control input-sm"></td>' +
                '<td><input type="hidden" value="1" class="form-control input-sm" placeholder="Tag" name="jsort[]"></td>' +
                '<td><input type="hidden" value="SIN" class="form-control input-sm" placeholder="Tag" name="jchild[]"></td>' +
                '<td><input type="hidden" value="N" class="form-control input-sm" placeholder="Tag" name="jsub[]"></td>' +
                '<td><input type="hidden" value="TDL" class="form-control input-sm" placeholder="Tag" name="jref[]"></td>' +
