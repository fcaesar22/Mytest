...
<div class="row">
    ...
    <div class="col-md-12" align="center">
    		<h4 class="card-title">Edit Article Content DensLife&Style</h4>
    </div>
</div>
<hr>
<br>
...
<style>
    ...
    <div id="content-wrapper">
      	<div class="container-fluid">
            <form action="<?php echo site_url('denslife/denslife/update_article');?>" method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>Article Content 1</label>
                            <textarea id="article_content_1" name="article_content_1" class="wysiwyg-editor" required></textarea>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
            ...
            $.ajax({
                ...
                success : function(data){
                    $.each(data, function(i, item){
                        var art1 = data[i].article_content_1;
                        $('[name="article_content_1"]').trumbowyg('html', art1);
                        var art2 = data[i].article_content_2;
                        $('[name="article_content_2"]').trumbowyg('html', art2);
                    });
                }
            });
        }
