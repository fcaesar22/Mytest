...
<div class="row">
    ...
    <div class="col-md-12" align="center">
        <h4 class="card-title">Edit Social TV</h4>
    </div>
</div>
<hr>
<br>

<form method="POST" action="<?php echo base_url("socialtv/socialtv/update_socialtv"); ?>" id="form_submit">
    <div class="row">
        <div class="col-md-12">
        ...
        <div class="col-md-12" align="center">
            <div class="col-xl-6 col-lg-3 col-sm-12 col-6" align="center">
                <div class="contacts__item" id="con" align="center">
                    ...
                    <div class="form-group">
                        <input type="hidden" name="socialtv_id" id="socialtv_id" value="<?php echo $socialtv_id?>">
...
$(document).ready(function() {
    ...
    function get_poster_highlight(){
        var socialtv_id = $('[name="socialtv_id"]').val();
        $.ajax({
            url : "<?php echo site_url('socialtv/socialtv/get_poster_highlight');?>",
            method : "POST",
            data :{socialtv_id :socialtv_id},
            async : true,
            dataType : 'json',
            success : function(data){
                    $('[name="socialtv_name"]').val(data.socialtv_name).trigger('change');
                    $('[name="socialtv_description"]').val(data.socialtv_description).trigger('change');
                    $('[name="channel_id"]').val(data.channel_id).trigger('change');
                    $('#source_content').val(data.socialtv_source).trigger('change');
                    $('#source_content').trigger({
                        type: 'select2:select',
                        params: {
                            data: data.socialtv_source
                        }
                    });
                    var str = data.socialtv_category.split(",");
