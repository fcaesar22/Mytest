...
<div class="row">
    ...
    <div class="col-md-12" align="center">
        <h4 class="card-title">Edit Image Poster</h4>
    </div>
</div>
<hr>
<br>

<form method="POST" action="<?php echo base_url("image/imagedenslife/update_poster"); ?>" id="form_submit">
    ...
    <input type="hidden" name="poster_id1" id="poster_id1" value="<?php if ($poster!=null) { echo $poster[0]['poster_id']; } ?>">
    <input type="hidden" name="poster_id2" id="poster_id2" value="<?php if ($poster!=null) { echo $poster[1]['poster_id']; } ?>">
    <input type="hidden" name="poster_id3" id="poster_id3" value="<?php if ($poster!=null) { echo $poster[2]['poster_id']; } ?>">
    <input type="hidden" name="poster_update" value="<?php date_default_timezone_set("Asia/Jakarta"); echo date('Y-m-d H:i:s')?>">
    <div class="col-md-12" align="center">
...
// function insert_poster(image){
//     $.ajax({
//         url : "<?php echo site_url('image/imagedenslife/insert_poster');?>",
//         method : "POST",
//         data :{image :image},
//         async : true,
//         dataType : 'json',
