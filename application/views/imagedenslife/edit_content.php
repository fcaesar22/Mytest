                    ...
                    <tr id="row0" class="jdr1">
                        ...
                        <div class="contacts__item" id="con" align="center">
                            ...
                            <a href="#" class="contacts__img">
                                <img id="img_pos0" width="85" height="85" src="" alt="">
                            </a>
                    ...
                    <td class="video">
                        <div class="col-xl-2 col-lg-3 col-sm-4 col-6" align="center">
                            <div class="contacts__item" id="vid" align="center">
                                <label>Video</label>
                                <a href="#" class="contacts__img">
                                    <img id="vid_pos0" width="85" height="85" src="" alt="">
                                </a>
                                <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="btn-delete" class="btn btn-danger btn-delete">Delete</a>
            </div>
        </div>
    </div>
</div>
...
$(document).ready(function (){
    ...
    $("body").on('click', '.btn-delete', function (e) {
        var datas = $('.id_pstr0').val(); // retrieve the hid by data attr.
        $.ajax({
            type: "POST",
            url: "http://localhost/sa/image/imagedenslife/inactive_poster",
            data: { hid : datas }, // pass it as POST parameter
            success: function(data){
                alert("I got a view");
                console.log(datas);
            }
        ...
        e.preventDefault();
        if($("#table-details tr:last-child").attr('id') != 'row0'){
                ...
                if(data!=null){
                    ...
                    var hidden_fields=''
                        for (var j = 0; j < val.length; j++) {
                            ...
                            '<input type="hidden" class="form-control input-sm id_pstr'+j+'" name="poster_id[row' + i +'][]" value="'+val[j].poster_id+'">'+
                        ...
                        '<div class="contacts__item" id="con" align="center">' +
                            '<label>Image Poster</label>' +
                            '<a href="#" class="contacts__img"><img id="img_pos'+ i +'" src="'+val[0].poster_url+'" width="85" height="85" alt=""></a>' +
                            '<div class="form-group">' +
            ...
            success : function(data){
                ...
                if(data!=null){
                    ...
                    var hidden_fields=''
                        ...
                        '<label>Video</label>' +
                        '<a href="#" class="contacts__img">' +
                        '<img id="vid_pos'+ i +'" src="'+val[0].poster_url+'" width="85" height="85" alt="">' +
                        '</a>' +
                        '<div class="form-group">' +
                        ...
                        '</div>' +
                        '</td>'+
                        '<input type="hidden" class="form-control input-sm" name="video_url[bar' + i +'][]" required value="'+val[0].stream_url+'">'+
                        '<input type="hidden" class="form-control input-sm" name="stream_id[bar' + i +'][]" value="'+val[0].stream_id+'">'+
                        hidden_fields+'</tr>'
                        i++;
                    })
