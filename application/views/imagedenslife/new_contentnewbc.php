    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button id="embed_vid" type="button" class="btn btn-link">Embed</button>
                <button type="button" class="btn btn-link" data-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
...
$(document).ready(function () {
    ...
    $('#embed_vid').click(function () {
        console.log(default_content);
            
        var _embedvid = '<div name="embed_sel" class="col-xl-2 col-lg-3 col-sm-4 col-6" align="center"><div class="contacts__item" id="embed" align="center"><label>Image</label><a href="#" class="contacts__img"><img id="embed_pos" src="" alt=""></a><a class="btn btn-success btn-sm" name="embed_images" id="embed_images">Choose Image</a></div></div><textarea id="embed_video" name="embed_video" class="wysiwyg-editor"></textarea>';

        console.log(_embedvid);
        $('#changing-video').html(_embedvid);
...
$(document).ready(function (){
    $("body").on('click', '.btn-add-vid', function (e) {
        ...
        '<td class="video"><div class="col-xl-2 col-lg-3 col-sm-4 col-6" align="center"><div class="contacts__item" id="vid" align="center"><label>Video</label><a href="#" class="contacts__img"><img id="vid_pos'+$sr+'" src="" alt="" width="85" height="85"></a><div class="form-group"><input id="vid_00'+$sr+'" type="hidden" required="" class="form-control input-sm textVideo" placeholder="URL" name="stream_url[vid_00'+ $sr +'][]" required><i class="form-group__bar"></i></div><a class="btn btn-light btn-sm" name="stream_url[]" onclick="show_modal(\'vid\', \'vid_pos'+$sr+'\', \'vid_00'+$sr+'\')">Choose Image</a></div></div></td>' +
        '<td><input type="hidden" class="form-control input-sm" name="video_id[vid_00'+ $sr +'][]" value="<?php echo $article_id?>"></td>' +
