...
<div class="card-body">
    ...
    <hr>
    <br>
    <form name="form_img" id="form_img" method="POST" action="<?php echo base_url("image/imagedenslife/update_content"); ?>">
        <div class="col-md-6">    
    ...
    <form name="form_vid" id="form_vid" method="POST" action="<?php echo base_url("image/imagedenslife/update_video"); ?>">
        <div class="col-md-6">    
            <table style="width: 100%" class="table">
                ...
                <tr id="bar0" class="ris1">
                    ...
                    <td><input type="hidden" class="form-control input-sm" name="stream_type[bar0][]" value=""></td>
                    <td><input type="hidden" class="form-control input-sm" name="product_id[bar0][]" value=""></td>
                </tr>
                </tbody>
            </table>
        </div>
    ...
    $("#submitForms").click(function(e) {
        ...
        $.post($("#form_img").attr("action"), $("#form_img").serialize(), function() {
            ...
            function() {
                ...
                window.location.href = '<?php echo base_url() ?>denslife/denslife';
            });
        });
    });
});
...
function getUrlVideo(){
    ...
    $('#' + info_id).find('[name="product_id['+info_id+'][]"]').val(prodid);
...
function getUrlEmbed(){
    $.ajax({
        ...
        success: function (data) {
            ...
            var info_id = $('#modal-vd').attr('data-vidid-name');
            var matche = info_id.replace("bar", "");
            var matches = +matche+1;
            var prodid = 'EMB_'+'<?php echo $article_id?>'+'_'+matches;
            $('#streamtype').val('EMB')
            $('#prodid').val(prodid);
...
$(document).ready(function (){
    $("body").on('click', '.btn-add-vid', function (e) {
        ...
        '<td><input type="hidden" class="form-control input-sm" name="stream_type[bar'+ $sr +'][]" value=""></td>' +
        '<td><input type="hidden" class="form-control input-sm" name="product_id[bar'+ $sr +'][]" value=""></td>' +
        '</tr>';
        $sr++;
...
$(document).ready(function() {
    ...
    function get_data_image(){
        ...
        $.ajax({
            url : "<?php echo site_url('image/imagedenslife/get_data_image');?>",
            method : "POST",
...
$(document).ready(function() {
    ...
    function get_data_video(){
        ...
        $.ajax({
            url : "<?php echo site_url('image/imagedenslife/get_data_video');?>",
            method : "POST",
            data :{article_id :article_id},
            async : true,
            dataType : 'json',
            success : function(data){
                ...
                if(data!=null){
                    ...
                    var hidden_fields=''
                        ...
                        '<input type="hidden" class="form-control input-sm" name="stream_type[bar' + i +'][]" value="'+val[i].stream_type+'">'+
                        '<input type="hidden" class="form-control input-sm" name="product_id[bar' + i +'][]" value="'+val[i].product_id+'">'+
                        hidden_fields+'</tr>'
                        i++;
                    })
