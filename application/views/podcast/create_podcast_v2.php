        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <hr>
                    <br>
                    <form method="POST" action="<?php echo base_url("podcast/podcast_v2/save_podcast"); ?>" id="form_submit">
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="podcast_name" id="podcast_name" placeholder="Social TV Name" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
