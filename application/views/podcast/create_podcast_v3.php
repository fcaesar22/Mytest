...
<link rel="stylesheet" href="<?=base_url()?>assets/fontawesomeweb/css/all.css">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-default iconpicker-component"><i class="" id="tester" name="tester"></i></button>
