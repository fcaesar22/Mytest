...
<div class="card">
	...
	<div class="row">
		...
		<div class="col-md-12" align="center">
			<h4 class="card-title">Add Sub Category What's On</h4>
		</div>
	</div>
	<hr>
	<br>
	<div id="content-wrapper">
		<div class="container-fluid">			
			<form action="<?php base_url('subcategory_whatson/sub_wo/add') ?>" method="post" enctype="multipart/form-data" >
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input class="form-control <?php echo form_error('sub_category_whatson_name') ? 'is-invalid':'' ?>"
							 type="text" name="sub_category_whatson_name" placeholder="Sub Category What's On Name" />
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<textarea class="form-control <?php echo form_error('sub_category_whatson_description') ? 'is-invalid':'' ?>"
							 name="sub_category_whatson_description" placeholder="Sub Category What's On description..."></textarea>
							<div class="invalid-feedback">
