...
<div class="card">
      ...
      <div class="row">
          ...
          <div class="col-md-12" align="center">
              <h4 class="card-title">Add What's On</h4>
          </div>
      </div>
      <hr>
      <br>
      ...
      <div class="container-fluid">
        <form action="<?php echo site_url('whatson/save_product');?>" method="post">
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group" id='farid'>
                    <label>What's On Image</label><a class="btn btn-light btn-sm callfunction" data-toggle="modal" name="whatson_image" data-target="#modal-image" id='butimage'>Choose Image</a>
                ...
                <div class="form-group">
                    <label>Category What's On Name</label>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control js-example-basic-single" name="subcategory" id="subcategory" required>
                      <option value="">No Selected</option>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <select class="form-control js-example-basic-single" name="channelwo" id="channelwo" required>
                      <option value="">No Selected</option>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                    ...
                    <select class="form-control js-example-basic-single" name="thumbnailname" id="thumbnailname" required>
                      <option value="">No Selected</option>
...
<div class="modal fade" id="modal-video" tabindex="-1" style="display: none;" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        ...
        <form action="" method="get" id="form_embed">
            <div class="modal-header">
                <h5 class="modal-title pull-left">Insert Video</h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
            ...
            <div class="modal-footer">
                <button type="button" class="btn" onclick="getUrlVideo()">Save</button>
                <button type="button" class="btn btn-link" data-dismiss="modal">Close</button>
            </div>
        </form>
        </div>
...
function getUrlVideo(){
    var info = $('#modal-video').attr('data-trumbo');
    var url = $('#modal-video #url').val();
    var width = $('#modal-video #maxwidth').val();
    var height = $('#modal-video #maxheight').val();
    if (info == 1)
    {
      var editorVal = $('#whatson_description').val();
      var newHtml = editorVal + '<iframe width="' + width + '" height="' + height + '" src="' + url + '" frameborder="0" allowfullscreen="allowfullscreen"></iframe>';
      $('#whatson_description').trumbowyg('html', newHtml);
    }
...
$(document).ready(function () {
  ...
  $('#whatson_description').trumbowyg({
        ...
        btnsDef: {
            ...
            video: {
                dropdown: ['insertvideo','embedvideo'],
                ico: 'noembed'
            },
            insertvideo: {
                fn: function() {
                    $('#modal-video').attr('data-trumbo', 1);
