...
<div class="card">
	...
	<div class="row">
		...
		<div class="col-md-12" align="center">
			<h4 class="card-title">Add Category What's On</h4>
		</div>
	</div>
	<hr>
	<br>
	<div id="content-wrapper">
		<div class="container-fluid">			
			<form action="<?php base_url('category_whatson/cat_wo/add') ?>" method="post" enctype="multipart/form-data" >
				<div class="row">
					<div class="col-md-6">
						<div class="form-group">
							...
							<input class="form-control <?php echo form_error('category_whatson_name') ? 'is-invalid':'' ?>"
							 type="text" name="category_whatson_name" placeholder="Category What's On Name" />
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<textarea class="form-control <?php echo form_error('category_whatson_description') ? 'is-invalid':'' ?>"
							 name="category_whatson_description" placeholder="Category What's On description..."></textarea>
							<div class="invalid-feedback">
