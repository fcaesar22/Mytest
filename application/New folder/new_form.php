	...
	<div id="content-wrapper">
		<div class="container-fluid">
			<div class="well" style="margin-top:50px;">
			    ...
			    <fieldset>
			      	<legend></legend>
			      	<form action="<?php echo site_url('denslife/save_product');?>" method="post">
			        	...
			        	<div class="row step-content" id="step-2">
			          		<div class="col-md-12">
								<div class="form-group">
									...
									<select class="form-control js-example-basic-single" name="kategori_id[]" id="kategori_id" multiple="multiple" required="">
